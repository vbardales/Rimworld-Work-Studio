...
remaining:
  ...
  - "2026-09-25 publication path: the Workshop shows a 1.1.1 preview-only update of 2026-09-22 uploaded from the game (content not established); the next version is 1.2.0, published by .github/workflows/publish-tag.yml. Dry-run passed for commit 7a9ffecdba5e8d97796ad029857b8dcb46a68111, run 36081371771 (staged 47 files, 0.69 MB; description diff = one new bullet plus list formatting; preview identical to the page; nothing sent to Steam). Workshop images are final in Art/Workshop/ready/ (uploaded by hand). Still open: the owner launches and approves publish; v1.1.0 tag (never published) to delete with her word; the two done -> tested runtime items; the Steam page images to upload by hand."
