...
workshop:     3792836684
remaining:
  - "verified: 2026-09-22 minimal English, minimal French and Better Work Tab full Pickle passes each report 49 passed, 0 failed, 6 skipped; Work Type Tag reports 50 passed, 0 failed, 5 skipped. Each complete report was copied to Tests/Pickle/evidence before the shared lock was released and relevant captures were opened; the copies of the minimal English/French, Enhanced Work Tab, Work Type Tag and Better Work Tab passes were deleted on 2026-09-23 to free disk, replaced by the 2026-09-23 runs (summaries in docs/runs/2026-09-22.md and 2026-09-23.md)."
  ...
  - "measured 2026-09-23, RIMMSQOL full pass (docs/runs/2026-09-23.md): 55 scenarios, 49 passed, 4 failed, 2 skipped. Feature 16 (the RIMMSQOL shortcut, all four scenarios) PASSED. New finding, cause not established: the save scenario 'two types, loaded with one' fails under RIMMSQOL with an ArgumentOutOfRangeException from RIMMSqol.DefMapSaveStateFix.Postfix, RIMMSQOL's own postfix on DefMap.ExposeData for work types; not seen in the minimal or Enhanced Work Tab passes. The other three failures are the publication-shot fixture name, fixed in 07ca835."
  - "verified 2026-09-23, Work Type Tag full pass (docs/runs/2026-09-23.md): 55 scenarios, 47 passed, 0 failed, 8 skipped, exitReason passed, setName avec-work-type-tag, on the final mod DLL 3dcfdb1. Feature 17 passed. The 8 skips are the @requires scenarios of mods this set does not stage (publication shots, Fluffy, RIMMSQOL). Captures not yet opened."
  - "verified 2026-09-23, Better Work Tab full pass (docs/runs/2026-09-23.md): 55 scenarios, 46 passed, 0 failed, 9 skipped (the @requires ones of unstaged mods), exitReason passed, setName avec-better-work-tab, final mod DLL 3dcfdb1. The Work types button and both save scenarios pass under it."
  - "verified 2026-09-23, Compact Work Tab coexistence pass (docs/runs/2026-09-23.md): 55 scenarios, 46 passed, 0 failed, 9 skipped, exitReason passed, setName incompat-compact-worktab (historical name), final mod DLL 3dcfdb1. The Work types button and both save scenarios pass with it loaded, which agrees with removing its incompatibility declaration."
  ...
  - "superseded 2026-09-25 (the item is an update, not a first publication, and the fail-fast policy of AUDIT.md applies): the Workshop images are final, the description already lacked the Compact Work Tab sentence, and 1.2.0 is published. What stays open is in the next entry."
  - "verified 2026-09-26, Fluffy Work Tab button replay on WorkStudio deb224e: 02-work-tab-button.feature under incompat-fluffy-worktab, 3 scenarios, 3 passed, exitReason passed, 1 attempt (docs/runs/2026-09-25.md; evidence Tests/Pickle/evidence/0925-fluffy-button-5). The capture with the pointer on the button shows it clear of Fluffy toggles. The open red of 1.2.0 is closed; the fix is unreleased. Other final-build passes still owed."
  - "2026-09-25 published as 1.2.0 through .github/workflows/publish-tag.yml: dry-run run 36081371771 on 7a9ffecdba5e8d97796ad029857b8dcb46a68111, publish run 36118066093 on the same SHA (options update_preview and update_description on), approved by the owner, tag v1.2.0 and GitHub release created by the CI at 09:27:35Z. Public page read through the Steam API afterwards: updated 09:27:24Z, tags Mod and 1.6, description carries the new icons bullet; the BBCode rendering on the page itself was not looked at. The Workshop history (pasted by the owner 2026-09-25, uploads from the game): 1.1.0 on 2026-09-22 09:09 = the commit of tag v1.1.0 (bf89753); '1.1.1 Update of mod's preview picture' at 12:00 = the same DLL plus the new Preview, the Compact Work Tab entry removed from incompatibleWith, and the ATTRIBUTION copy (c27b8af); then 1.2.0. CHANGELOG.md has one section per version. semantic-release was removed from the repository (04dcc84). Fail-fast gates (AUDIT.md, prepublished -> published): no red scenario without a green replay is NOT met for one scenario, the Work types button under Fluffy Work Tab (red 2026-09-23, fix written, the 2026-09-25 replay did not run: Fluffy Work Tab was not installed in the launcher's Workshop folders); the owner approved the publish knowing the fix was unreplayed. Still owed after publication: that replay (or a rollback to v1.0.0 if it comes back red), the other final-build passes, the captures of the 2026-09-25 Enhanced Work Tab pass opened, the three Steam gallery images uploaded by hand, note that the tag v1.1.0 stays and is right (it is the commit uploaded as 1.1.0 at 09:09); v1.1.1 has no tag."
  - "verified 2026-09-25, Enhanced Work Tab full pass on the published build 7a9ffec: 55 scenarios, 46 passed, 0 failed, 9 skipped, exitReason passed, setName avec-enhanced-work-tab (docs/runs/2026-09-25.md; captures on disk in the ignored Tests/Pickle/evidence/0925-ewt-full, all nine opened on 2026-09-26: see docs/runs/2026-09-25.md). The Work types button and feature 05 pass under it."
