# 2026-09-22-minimal-french

- Set: `sans-facultatifs`, language: French
- Result: **55 scenarios, 49 passed, 0 failed, 6 skipped**, exitReason `passed`
- Full report (screenshots, log, junit): `Tests/Pickle/evidence/2026-09-22-minimal-french` on disk, ignored by git
