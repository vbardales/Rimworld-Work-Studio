# 2026-09-22-avec-work-type-tag

- Set: `avec-work-type-tag`, language: English
- Result: **55 scenarios, 50 passed, 0 failed, 5 skipped**, exitReason `passed`
- Full report (screenshots, log, junit): `Tests/Pickle/evidence/2026-09-22-avec-work-type-tag` on disk, ignored by git
